...
export class DeleteCapacityViewHandler
    implements ICommandHandler<DeleteCapacityViewCommand, FormResponse>
{
    constructor(
    ...
    async execute(command: DeleteCapacityViewCommand): Promise<FormResponse> {
        ...
        if (queryResult.summary.updateStatistics.containsUpdates()) {
            ...
            return new FormSuccessResponse({
                message: "Visningen blev slettet.",
            });
        }
        return new FormErrorResponse({
            message: "Der skete en fejl under sletningen af visningen.",
        });
    }
