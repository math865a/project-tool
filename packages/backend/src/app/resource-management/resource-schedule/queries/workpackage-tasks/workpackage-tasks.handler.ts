...
export class WorkpackageTasksQueryHandler implements IQueryHandler<WorkpackageTasksQuery> {
    constructor(private client: Neo4jClient) {}

    async execute({ instruction, workpackageId }: WorkpackageTasksQuery): Promise<any> {
